...
/**
 * Graph for asking for developer poll for all sprints
 */
public class GraphAllDeveloperPollDialog 
	extends TwoButtonDialog 
	implements MetricListener {

	public GraphAllDeveloperPollDialog(JFrame owner) {
		super(owner);
		...
		setSize(320, 150);
		setTitle(i18n.tr("Plot All Sprint Developer Poll"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals("StandardDialog.OK")) {
			_metricModel.calculateAllSprintDeveloperPoll(_questionInput.getSelectedId());
		} else {
	...
	/// serialization id
	private static final long serialVersionUID = -2927404943806468389L;
