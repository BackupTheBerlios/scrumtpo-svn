	...
	implements MetricListener, DeveloperListener, TaskListener, SprintBacklogListener 
{
	...
	public CustomerPollDialog(Frame parent)
	{
		...
		JLabel q1 = new JLabel(i18n.tr("Sodelovanje z razvojno skupino v èasu razvoja") + ":");
		...
		JLabel q3 = new JLabel(i18n.tr("<html> Popolnost izdelane rešitve (Ali so bile realizirane vse zahteve, " + newline +
		...
		JLabel q4 = new JLabel(i18n.tr("<html> Skladnost izdelane rešitve s prièakovanji (Ali se izdelana programska " + newline +
		...
		JLabel q5 = new JLabel(i18n.tr("<html> Intuitivnost uporabniškega vmesnika (Ali je sistem enostaven " + newline +
		...
		JLabel q6 = new JLabel(i18n.tr("<html> Uporabnost/Koristnost izdelanih programov (Ali izdelani programi olajšajo delo uporabniku?)") + ":");
		...
		JLabel q7 = new JLabel(i18n.tr("<html> Odsotnost napak, zanesljivost delovanja, robustnost " + newline +
									   "(Ali so izdelani programi brez napak? Ali izdelana rešitev deluje stabilno, brez prekinitev?))</html>") + ":");
		...
		JLabel q8 = new JLabel(i18n.tr("Kakovost oddanih Sprint Backlog-ov, pravoèasnost oddaje") + ":");
