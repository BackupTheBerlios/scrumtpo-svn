	...
	implements MetricListener, DeveloperListener, TaskListener, SprintBacklogListener 
{
	...
	public CustomerPollDialog(Frame parent)
	{
		...
		JLabel q1 = new JLabel("Sodelovanje z razvojno skupino v èasu razvoja:");
		...
		JLabel q2 = new JLabel("Odzivnost razvijalcev na želje, spremembe v zahtevah:");
		...
		JLabel q3 = new JLabel("<html> Popolnost izdelane rešitve " + newline + "(Ali so bile realizirane vse zahteve, " +
		...
		JLabel q4 = new JLabel("<html> Skladnost izdelane rešitve s prièakovanji " + newline + "(Ali se izdelana programska " +
									   "oprema ujema z vašimi prièakovanji na zaèetku cikla?)</html>:");
		...
		JLabel q5 = new JLabel("<html> Intuitivnost uporabniškega vmesnika " + newline + "(Ali je sistem enostaven " +
		...
		JLabel q6 = new JLabel("<html> Uporabnost/Koristnost izdelanih programov " + newline + "(Ali izdelani programi olajšajo delo uporabniku?):");
		...
		JLabel q8 = new JLabel("Kakovost oddanih Sprint Backlog-ov, pravoèasnost oddaje:");
		...
		JLabel q9 = new JLabel("Splošna ocena zadovoljstva z delom razvojne skupine:");
		...
		JLabel q10 = new JLabel("Splošna ocena kakovosti izdelanih programov:");
