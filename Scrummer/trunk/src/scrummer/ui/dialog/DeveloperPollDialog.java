	...
	implements MetricListener, DeveloperListener, TaskListener, SprintBacklogListener 
{
	...
	public DeveloperPollDialog(Frame parent) {
		...
		JLabel q2 = new JLabel(i18n.tr("<html> Ocena časa za posamezno zahtevo v Product Backlogu " + newline +
		...
		JLabel q4 = new JLabel(i18n.tr("<html> Obremenjenost z administracijo " + newline + "(5 - vodenje Sprint Backloga " +
									   " ni obremenjujoše, 1 - vodenje Sprint Backloga je zelo obremenjujoče)</html>") + ":");
		...
		JLabel q5 = new JLabel(i18n.tr("<html> Tehnične težave na začetku Sprinta " + newline + "(5 - ni bilo težav, " +
		...
		JLabel q6 = new JLabel(i18n.tr("<html> Vsebinske težave (razumevanje zahtevane funkcionalnosti) na začetku " +
		...
		JLabel q7 = new JLabel(i18n.tr("<html> Tehnične težave na koncu Sprinta (5 - ni bilo težav, 1 - bilo je veliko težav)</html>") + ":");
		...
		JLabel q8 = new JLabel(i18n.tr("<html> Vsebinske težave (razumevanje zahtevane funkcionalnosti) na koncu Sprinta " + newline +
		...
		JLabel q13 = new JLabel(i18n.tr("<html> Splopna ocena vašega zadovoljstva s potekom dela na projektu") + ":");
		...
		JLabel q14 = new JLabel(i18n.tr("<html> Splošna ocena metodologije Scrum (Ali je ta metodologija " + newline +
									    "koristna za delo razvojne skupine? Ali bi jo priporočili drugim razvijalcem?)</html>") + ":");
