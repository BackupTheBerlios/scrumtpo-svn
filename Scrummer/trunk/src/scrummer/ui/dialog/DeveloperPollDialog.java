	...
	implements MetricListener, DeveloperListener, TaskListener, SprintBacklogListener 
{
	...
	public DeveloperPollDialog(Frame parent)
	{
		...
		JLabel q2 = new JLabel(i18n.tr("<html> Ocena èasa za posamezno zahtevo v Product Backlogu " + newline +
		...
		JLabel q5 = new JLabel(i18n.tr("<html> Tehniène težave na zaèetku Sprinta (5 – ni bilo težav, " + newline +
		...
		JLabel q6 = new JLabel(i18n.tr("<html> Vsebinske težave (razumevanje zahtevane funkcionalnosti) na zaèetku " + newline +
									   " Sprinta (5 – ni bilo težav, 1 – bilo je veliko težav) </html>") + ":");
		...
		JLabel q7 = new JLabel(i18n.tr("<html> Tehniène težave na koncu Sprinta (5 – ni bilo težav, 1 – bilo je veliko težav)</html>") + ":");
		...
		JLabel q13 = new JLabel(i18n.tr("<html> Splošna ocena vašega zadovoljstva s potekom dela na projektu") + ":");
