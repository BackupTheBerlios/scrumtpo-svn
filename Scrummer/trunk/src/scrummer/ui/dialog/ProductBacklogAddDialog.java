...
public class ProductBacklogAddDialog extends JDialog implements MouseListener
{
	public ProductBacklogAddDialog(Frame owner) throws SQLException 
	{	
		super(owner, ModalityType.APPLICATION_MODAL);
		
		setTitle(i18n.tr("Add Product Backlog"));
